...
public class N161990 {
	...
	public static int[] solution(String[] wallpaper) {
        int[] answer = new int[4]; // minX, minY, maxX, maxY
        // 최소값이 항상 0보다 커야하므로
        ...
        for(int i=0; i<wallpaper.length; i++) {
        	...
        	if(minY > -1) { // 파일이 있을 때
        		...
        		if(answer[3] < maxY+1) answer[3] = maxY+1;
        	}
        }
	...
	/* 
	 * 같은 줄에 있는 파일들 중 맨 첫번째, 맨 마지막 파일 위치만 비교하면 됨
	 * 
	 * 파일이 하나밖에 없는 경우, 이 파일의 x, y값이 가장 작은 값보다 작은지 혹은 가장 큰 값보다 큰지 확인
	 * x값 y값을 각각 비교해야함
	 * 
	 */
